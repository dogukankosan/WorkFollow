...
{
    public partial class IsRead : DevExpress.XtraEditors.XtraForm
    {
        public IsRead()
        {
            InitializeComponent();
        ...
        void List()
        {
            gridControl1.DataSource = (from x in db.Message.Where(x => x.Receiver == Entitiy.Trash.ID2 && x.IsRead == false && x.Status == true)
                                       select new
                                       {
                                           x.ID,
                                           x.Sender,
        ...
        private void IsRead_Load(object sender, EventArgs e)
        {
            List();
        }
        ...
        private void IsRead_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
        {
