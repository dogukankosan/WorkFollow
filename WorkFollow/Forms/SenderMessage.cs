...
{
    public partial class SenderMessage : DevExpress.XtraEditors.XtraForm
    {
        ...
        void List()
        {
            gridControl1.DataSource = (from x in db.Message.Where(x => x.Sender == Entitiy.Trash.ID2 && x.Status == true)
                                       select new
                                       {
                                           x.ID,
                                           x.Receiver,
        ...
        private void SenderMessage_Load(object sender, EventArgs e)
        {
            List();
        }

        private void SenderMessage_KeyDown(object sender, KeyEventArgs e)
        {
